...
router.post('/seller-register', registerLimiter, authControllers.seller_register)
...
router.post('/change-password', authMiddleware, authLimiter, authControllers.change_password)
